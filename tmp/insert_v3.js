...
for (const l of leads) {
  ...
  const vals = [
    id, l.address, l.area, l.image_url || null,
    JSON.stringify(l.gallery || []), l.streetview_url || null, l.floorplan_url || null,
    l.list_price || null, l.realistic_price || null, l.sqft || null, null,
    l.nearest_tube_distance || null, l.park_proximity || null,
    l.commute_paternoster || null, l.commute_canada_square || null,
    (rp < lp ? 1 : 0), l.epc || null, l.tenure || null,
    l.service_charge || 0, l.ground_rent || 0, l.lease_years_remaining || 0,
    l.dom || null, l.neg_strategy || null, null, null,
    ...
    l.floor_level || null, l.source || "USER_SUBMISSION", l.source_name || null,
    0, l.analyst_notes || null,
    l.price_reduction_amount || null, l.price_reduction_percent || null, l.days_since_reduction || null,
    null, null, null, null, null, null, null, null, null,
    l.bedrooms || null, l.bathrooms || null,
    0, null, "active", today, "discovered",
    null, l.council_tax_band || null
  ];
